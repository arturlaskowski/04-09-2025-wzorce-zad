...
@SpringBootTest
class PaymentCardConcurrencySqlTests {
    ...
    @RepeatedTest(10)
    void concurrentWithdrawalNativeSqlTest() throws InterruptedException {
        //given
        ...
        Thread thread1 = new Thread(() -> {
            try {
                paymentCardService.withdrawFromCardNativeSql(paymentCardId, new BigDecimal("300"));
        ...
        Thread thread2 = new Thread(() -> {
            try {
                paymentCardService.withdrawFromCardNativeSql(paymentCardId, new BigDecimal("200"));
                successCount.incrementAndGet();
            } catch (Exception e) {
                System.out.println("Nieudana wypłata: " + e.getMessage());
            }
